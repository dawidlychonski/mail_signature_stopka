...
function FooterPreview({ data }) {
  useEffect(() => {
    ...
    // Otwieramy nowe okno przeglądarki i wklejamy HTML do jego dokumentu
    const newWindow = window.open('', '_blank');
    if (newWindow) {
      newWindow.document.write(html);
      newWindow.document.close();
    }
  }, [data]); // efekt uruchamiany za każdym razem, gdy zmienią się dane formularza

  // Komponent nie renderuje nic w aktualnym oknie – działa tylko poprzez efekt uboczny (window.open)
  return null;
}
